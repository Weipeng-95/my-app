...
<div class={isSearchMatch ? "grid grid-cols-2 gap-12" : ""}>
    <div>
            ...
            <div class="grid md:grid-cols-[0.35fr_0.8fr]">
                <div class="container mb-8">
                    ...
                    <p class="text-sm text-neutral-700 w-72">
                        Hier sind die grundlegende Informationen von dieser
                        Person
                    </p>
                </div>
                ...
                <div>
                    <div class="grid gap-3 md:grid-cols-2 md:gap-6 mb-3">
                        ...
                        <div>
                            <Label class="text-md font-semibold" for="name"
                                >Name</Label
                            >
                            <Input
                                id="name"
                    ...
                    <div class="grid gap-3 md:grid-cols-2 md:gap-6 mb-3">
                        ...
                        <div>
                            <Label class="text-md font-semibold" for="age"
                                >Alter</Label
                            >
                            <Input
                                id="age"
        ...
        {:else}
            <div
                class="grid {isSearchMatch
                    ? ''
                    : 'md:grid-cols-[0.25fr_0.65fr]'} "
            >
                <div class="container mb-8">
                    <div class="text-xl font-bold mb-1">Persönliche Daten</div>
                    <p class="text-sm text-neutral-700 w-72">
        ...
        {#if isEditing}
            <div class="grid md:grid-cols-[0.35fr_0.8fr]">
                <div class="container mb-8">
                    ...
                    <p class="text-sm text-neutral-700 w-72">
                        Hier sind die Informationen, die für das Match wichtig
                        sind
                    </p>
                </div>
                ...
                <div>
                    <div class="grid gap-3 md:grid-cols-2 md:gap-6 mb-3">
                        <div class="md:flex md:flex-nowrap">
                            <Label
                                class="text-md font-semibold md:mr-5 mb-3 md:mb-0"
                            >
                                Erreichbarkeit-Häufigkeit
                                <Select
                                    class="mt-1 bg-secondary-50 font-normal border-2 border-[#846EA8] focus:border-[#47277D] focus:ring-transparent hover:shadow-[0_0_10px_#6C5297] focus:shadow-[0_0_10px_#6C5297]"
                                    items={times_a_week}
                                    bind:value={person.availability[0]
                                        .times_a_week}
                                />
                            </Label>
                            <Label class="text-md font-semibold">
                        ...
                        <div>
                            <Label
                                ...
                                for="living_form">Lebnesform</Label
                            >
                            <Input
                                id="living_form"
                                class="mt-1 bg-secondary-50 font-normal border-2 border-[#846EA8] focus:border-[#47277D] focus:ring-transparent hover:shadow-[0_0_10px_#6C5297] focus:shadow-[0_0_10px_#6C5297]"
                    ...
                    <div class="grid gap-3 md:grid-cols-2 md:gap-6 mb-3">
                        ...
                        <div>
                            <Label
                                class="text-md font-semibold"
                                for="speaking_style">Sprechweise</Label
                            >
                            <Input
                                id="speaking_style"
                                class="mt-1 bg-secondary-50 font-normal border-2 border-[#846EA8] focus:border-[#47277D] focus:ring-transparent hover:shadow-[0_0_10px_#6C5297] focus:shadow-[0_0_10px_#6C5297]"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-3">
                        <div>
                            <Label
                                class="text-md font-semibold"
                                for="general_mood">Grundstimmung</Label
                            >
                            <Input
                                id="general_mood"
                                class="mt-1 bg-secondary-50 font-normal border-2 border-[#846EA8] focus:border-[#47277D] focus:ring-transparent hover:shadow-[0_0_10px_#6C5297] focus:shadow-[0_0_10px_#6C5297]"
        ...
        {#if isEditing}
            <div class="grid md:grid-cols-[0.35fr_0.8fr]">
                <div class="container mb-8">
                    ...
                    <p class="text-sm text-neutral-700 w-72">
                        Hier sind die Informationen, die für interne
                        Mitarbeiter/-in relevant sind
                    </p>
                </div>
                ...
                <div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-3">
                        <div>
                            <Label class="text-md font-semibold" for="id"
                                >ID</Label
                            >
                            <Input
                                id="id"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-3">
                        ...
                        <div>
                            <Label class="text-md font-semibold" for="ddi"
                                >DDI</Label
                            >
                            <Input
                                id="ddi"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-3">
                        <div>
                            <Label
                                class="text-md font-semibold"
                                for="entry_date">Zugangsdatum</Label
                            >
                            <Input
                                id="entry_date"
                                class="mt-1 bg-secondary-50 font-normal border-2 border-[#846EA8] focus:border-[#47277D] focus:ring-transparent hover:shadow-[0_0_10px_#6C5297] focus:shadow-[0_0_10px_#6C5297]"
                        ...
                        <div>
                            <Label
                                class="text-md font-semibold"
                                for="cancellation_date">Abgangsdatum</Label
                            >
                            <Input
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-3">
                        ...
                        <div>
                            <Label
                                class="text-md font-semibold"
                                for="last_change">Letzte Änderung</Label
                            >
                            <Input
                                id="last_change"
                                class="mt-1 bg-secondary-50 font-normal border-2 border-[#846EA8] focus:border-[#47277D] focus:ring-transparent hover:shadow-[0_0_10px_#6C5297] focus:shadow-[0_0_10px_#6C5297]"
